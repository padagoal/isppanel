...
class EmpresasController extends Controller
{
    ...
    {    
		...
		$searchModel = new EmpresasBuscar();
     ...
     * @return mixed
     */
    public function actionView($empresa)
    {   
        $request = Yii::$app->request; 		
        if($request->isAjax){
            Yii::$app->response->format = Response::FORMAT_JSON;
            return [
                    'title'=> Yii::t('app',$this->title)."# ".$empresa,
                    'content'=>$this->renderAjax('view', [
                        'model' => $this->findModel($empresa),
                    ]),
                    'footer'=> Html::button(Yii::t('app','Close'),['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                            Html::a(Yii::t('app','Edit'),['update','empresa'=>$empresa],['class'=>'btn btn-primary','role'=>'modal-remote'])
                ];    
        }else{
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> Yii::t('app', "Add")." ".Yii::t('app', $this->title), 
                    'content'=>'<span class="text-success">Crear Empresas realizado</span>',
                    'footer'=> Html::button(Yii::t('app', 'Close'),['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                return $this->redirect(['updatemd', 'empresa' => $model->empresa]);
            } else {
     ...
     * @return mixed
     */
    public function actionUpdate($empresa)
    {
        $request = Yii::$app->request;  		
        $model = $this->findModel($empresa);
		if ($model->hasProperty('created_by')) {
        ...
        if($request->isAjax){
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                return $this->redirect(['view', 'empresa' => $model->empresa]);
            } else {
    ...
    /**
     * Delete an existing Empresas model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param string $empresa
     * @return mixed
     */
    public function actionDelete($empresa)
    {
        $request = Yii::$app->request;
        $this->findModel($empresa)->delete();
     ...
     /**
     * Delete multiple existing Empresas model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param string $empresa
     * @return mixed
     ...
     */
    protected function findModel($empresa)
    {
        if (($model = Empresas::findOne(['empresa' => $empresa])) !== null) {
            return $model;
        } else {
