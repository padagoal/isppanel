...
use app\models\Estadoclientes;
use app\models\EstadoclientesBuscar;
...
/**
 * EstadoclientesController implements the CRUD actions for Estadoclientes model.
 */
class EstadoclientesController extends Controller
{
    ...
    /**
     * Lists all Estadoclientes models.
     * @return mixed
     */
    public function actionIndex()
    {    
               
		$searchModel = new EstadoclientesBuscar();
    ...
    /**
     * Displays a single Estadoclientes model.
     * @param string $estado
     * @return mixed
     */
    ...
    /**
     * Creates a new Estadoclientes model.
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> Yii::t('app', "Add")." ".Yii::t('app', $this->title), 
                    'content'=>'<span class="text-success">Crear Estadoclientes realizado</span>',
                    'footer'=> Html::button(Yii::t('app', 'Close'),['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Updates an existing Estadoclientes model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing Estadoclientes model.
     * For ajax request will return json object
    ...
    public function actionDelete($estado)
    {
     ...
     /**
     * Delete multiple existing Estadoclientes model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param string $estado
     * @return mixed
    ...
    /**
     * Finds the Estadoclientes model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $estado
     * @return Estadoclientes the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($estado)
    {
        if (($model = Estadoclientes::findOne(['estado' => $estado])) !== null) {
            return $model;
        } else {
