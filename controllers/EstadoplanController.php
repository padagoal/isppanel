...
use app\models\EstadoplanBuscar;
...
/**
 * EstadoplanController implements the CRUD actions for Estadoplan model.
 */
class EstadoplanController extends Controller
{
    ...
    /**
     * Lists all Estadoplan models.
     * @return mixed
     */
    public function actionIndex()
    {    
               
		$searchModel = new EstadoplanBuscar();
    ...
    /**
     * Displays a single Estadoplan model.
     * @param string $estado
     * @return mixed
     */
    ...
    /**
     * Creates a new Estadoplan model.
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> Yii::t('app', "Add")." ".Yii::t('app', $this->title), 
                    'content'=>'<span class="text-success">Crear Estadoplan realizado</span>',
                    'footer'=> Html::button(Yii::t('app', 'Close'),['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Updates an existing Estadoplan model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing Estadoplan model.
     * For ajax request will return json object
    ...
    public function actionDelete($estado)
    {
     ...
     /**
     * Delete multiple existing Estadoplan model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param string $estado
     * @return mixed
    ...
    /**
     * Finds the Estadoplan model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $estado
     * @return Estadoplan the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($estado)
    {
        if (($model = Estadoplan::findOne(['estado' => $estado])) !== null) {
            return $model;
        } else {
