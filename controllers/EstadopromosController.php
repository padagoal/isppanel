...
use app\models\EstadopromosBuscar;
...
/**
 * EstadopromosController implements the CRUD actions for Estadopromos model.
 */
class EstadopromosController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all Estadopromos models.
     * @return mixed
     */
    public function actionIndex()
    {    
               
		$searchModel = new EstadopromosBuscar();
    ...
    /**
     * Displays a single Estadopromos model.
     * @param string $estado
     * @return mixed
     */
    ...
    /**
     * Creates a new Estadopromos model.
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> Yii::t('app', "Add")." ".Yii::t('app', $this->title), 
                    'content'=>'<span class="text-success">Crear Estadopromos realizado</span>',
                    'footer'=> Html::button(Yii::t('app', 'Close'),['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Updates an existing Estadopromos model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing Estadopromos model.
     * For ajax request will return json object
    ...
    public function actionDelete($estado)
    {
     ...
     /**
     * Delete multiple existing Estadopromos model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param string $estado
     * @return mixed
    ...
    /**
     * Finds the Estadopromos model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $estado
     * @return Estadopromos the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($estado)
    {
        if (($model = Estadopromos::findOne(['estado' => $estado])) !== null) {
            return $model;
        } else {
