...
use app\models\EstadoserviciosBuscar;
...
/**
 * EstadoserviciosController implements the CRUD actions for Estadoservicios model.
 */
class EstadoserviciosController extends Controller
{
    ...
    /**
     * Lists all Estadoservicios models.
     * @return mixed
     */
    public function actionIndex()
    {    
               
		$searchModel = new EstadoserviciosBuscar();
    ...
    /**
     * Displays a single Estadoservicios model.
     * @param string $estado
     * @return mixed
     */
    ...
    /**
     * Creates a new Estadoservicios model.
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> Yii::t('app', "Add")." ".Yii::t('app', $this->title), 
                    'content'=>'<span class="text-success">Crear Estadoservicios realizado</span>',
                    'footer'=> Html::button(Yii::t('app', 'Close'),['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Updates an existing Estadoservicios model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing Estadoservicios model.
     * For ajax request will return json object
    ...
    public function actionDelete($estado)
    {
     ...
     /**
     * Delete multiple existing Estadoservicios model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param string $estado
     * @return mixed
    ...
    /**
     * Finds the Estadoservicios model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $estado
     * @return Estadoservicios the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($estado)
    {
        if (($model = Estadoservicios::findOne(['estado' => $estado])) !== null) {
            return $model;
        } else {
