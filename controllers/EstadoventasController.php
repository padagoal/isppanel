...
use app\models\EstadoventasBuscar;
...
/**
 * EstadoventasController implements the CRUD actions for Estadoventas model.
 */
class EstadoventasController extends Controller
{
    ...
    /**
     * Lists all Estadoventas models.
     * @return mixed
     */
    public function actionIndex()
    {    
               
		$searchModel = new EstadoventasBuscar();
    ...
    /**
     * Displays a single Estadoventas model.
     * @param string $estado
     * @return mixed
     */
    ...
    /**
     * Creates a new Estadoventas model.
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> Yii::t('app', "Add")." ".Yii::t('app', $this->title), 
                    'content'=>'<span class="text-success">Crear Estadoventas realizado</span>',
                    'footer'=> Html::button(Yii::t('app', 'Close'),['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Updates an existing Estadoventas model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing Estadoventas model.
     * For ajax request will return json object
    ...
    public function actionDelete($estado)
    {
     ...
     /**
     * Delete multiple existing Estadoventas model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param string $estado
     * @return mixed
    ...
    /**
     * Finds the Estadoventas model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $estado
     * @return Estadoventas the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($estado)
    {
        if (($model = Estadoventas::findOne(['estado' => $estado])) !== null) {
            return $model;
        } else {
