...
/**
 * ServicioclienteBuscar represents the model behind the search form about `app\models\Serviciocliente`.
 */
class ServicioclienteBuscarTecnico extends Serviciocliente
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['empresa', 'contrato', 'tiposervicio', 'fechasolicitud', 'fecharealizacion', 'callcenter', 'estado', 'ubicacion', 'observaciones', 'created_by', 'created_at', 'modified_by', 'modified_at'], 'safe'],
            [['realizado'], 'boolean'],
            [['tecnico'], 'integer'],
        ];
    }
    ...
    public function search($params, $extraparams = null)
    {
        ...
        $tecnico = Yii::$app->user->identity->id;
