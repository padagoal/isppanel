...
<div class="contrato-form">
    ...
    <?= $form->field($model, 'diavto')->textInput() ?>
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
					...
					'empresa' => $model->empresa,'contrato' => $model->contrato,					
					],
                    ['role'=>'modal-remote','title'=> Yii::t('app', 'Create new') . ' Contratos','class'=>'btn btn-default']).
