...
use app\models\Estadofinanciacion;
...
$estadofinan = ArrayHelper::map(Estadofinanciacion::find()->all(), 'estado', 'estado');
?>
...
<div class="financiacion-form">
    ...
    <?= $form->field($model, 'estado')->dropdownlist($estadofinan) ?>
