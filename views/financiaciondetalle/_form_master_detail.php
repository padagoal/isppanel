...
<div class="financiaciondetalle-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
					...
					'producto' => $model->producto,'empresa' => $model->empresa,'financiacion' => $model->financiacion,					
					],
                    ['role'=>'modal-remote','title'=> Yii::t('app', 'Create new') . ' Financiaciondetalles','class'=>'btn btn-default']).
