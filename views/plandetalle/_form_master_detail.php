        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
					...
					'empresa' => $model->empresa,'plan' => $model->plan,'producto' => $model->producto,					
					],
                    ['role'=>'modal-remote','title'=> Yii::t('app', 'Create new') . ' Plandetalles','class'=>'btn btn-default']).
