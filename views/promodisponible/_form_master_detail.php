    ...
    <div class="promocion-index">
        <div id="ajaxCrudDatatable">
            <?=GridView::widget([
                ...
                'pjax'=>true,
                'columns' => require(__DIR__.'/../promociondetalle/_columns.php'),
                'toolbar'=> [
                    ['content'=>
                        Html::a('<i class="glyphicon glyphicon-plus"></i>', ['/promociondetalle/create',
                            'empresa' => $model->empresa,'promocion' => $model->promocion, 'plan' => $model->plan,
                        ],
