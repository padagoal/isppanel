...
'format' => ['date', 'php:d-m-Y'], 
    ...
    [
        ...
        'urlCreator' => function($action, $model, $key, $index) { 
			return Url::to(['/servicioclientedetalle/'.$action, 'empresa' => $model->empresa,'producto' => $model->producto,'contrato' => $model->contrato,'tiposervicio' => $model->tiposervicio,'fechasolicitud' => $model->fechasolicitud,]);
        },
