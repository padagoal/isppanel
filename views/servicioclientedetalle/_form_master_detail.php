...
<div class="servicioclientedetalle-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
					...
					'empresa' => $model->empresa,'producto' => $model->producto,'contrato' => $model->contrato,'tiposervicio' => $model->tiposervicio,'fechasolicitud' => $model->fechasolicitud,					
					],
                    ['role'=>'modal-remote','title'=> Yii::t('app', 'Create new') . ' Servicioclientedetalles','class'=>'btn btn-default']).
