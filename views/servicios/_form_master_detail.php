...
<div class="servicios-form">
    ...
    <?= $form->field($model, 'maximomensual')->textInput() ?>
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
					...
					'empresa' => $model->empresa,'servicio' => $model->servicio,					
					],
                    ['role'=>'modal-remote','title'=> Yii::t('app', 'Create new') . ' Servicios','class'=>'btn btn-default']).
